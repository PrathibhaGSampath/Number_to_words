...
word_combination.each do |key,words|
dictionary_data = file_data.grep(/^#{key}/).to_set
words.each do |word|
if dictionary_data.include?(word.upcase)
dictionary_words << word 
end
end
end
